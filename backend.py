...
# import pandas as pd
# db = pd.read_excel('BD-PRODUCTOS-ASISTENTE.xlsx') 
#df_historic = pd.read_excel('BD-PRODUCTOS-ASISTENTE.xlsx')
from langchain.sql_database import SQLDatabase
#db = SQLDatabase.from_uri("sqlite:///datosgrupohidraulica.db")
#db = SQLDatabase.from_uri("sqlite:///grupohidraulica.db")
#db = SQLDatabase.from_uri("sqlite:///ghidraulica.db")
db = SQLDatabase.from_uri("sqlite:///bdgrupohidraulica.db")
#db = SQLDatabase.from_uri("sqlite:///ecommerce.db")

#sql_db = SQLDatabase.from_pandas(db)
#db = pd.read_excel('BD-PRODUCTOS-ASISTENTE.xlsx',sheet_name='HISTÓRICO 15 MEJORES PROD') 
# 2. Importar las APIs
import api_key
import os
